...
export const AppRelationshipStatuses = {
  Active: 'active', Inactive: 'inactive', Suspended: 'suspended', Revoked: 'revoked',
} as const;

export const SecretKeyTokenTypes = { Bearer: 'bearer' } as const;
export const SecretKeyStatuses = { Active: 'active', Revoked: 'revoked', Expired: 'expired' } as const;
export const SecretKeyAuthResults = { Succeeded: 'succeeded', Failed: 'failed' } as const;

export const FileStatuses = {
  Uploading: 'uploading', Processing: 'processing', Available: 'available',
...
export const FileSourceTypes = {
  Direct: 'direct', UploadRequest: 'upload_request', Service: 'service',
} as const;
export const FileStorageEncodings = { Identity: 'identity', Brotli: 'br' } as const;
export const FileLinkStatuses = {
  Active: 'active', Revoked: 'revoked', Expired: 'expired', Disabled: 'disabled',
} as const;
export const FileLinkKinds = { Public: 'public' } as const;
export const FileLinkDeliveryModes = {
  Redirect: 'redirect', Download: 'download', Inline: 'inline',
} as const;
export const UploadRequestStatuses = {
  Pending: 'pending', Uploading: 'uploading', Fulfilled: 'fulfilled', Expired: 'expired',
...
export const PaymentNextActionTypes = {
  ConfirmPayment: 'confirm_payment', Execute: 'execute', Redirect: 'redirect',
  Authorize: 'authorize', None: 'none',
} as const;
export const PaymentConfirmationChannels = { Sms: 'sms', Email: 'email', Push: 'push' } as const;
export const PaymentMethodTypes = {
  MobileMoney: 'mobile_money', BankAccount: 'bank_account', Card: 'card', Motito: 'motito',
} as const;
export const MobileMoneyNetworks = {
  Airtel: 'airtel', Mtn: 'mtn', Telecel: 'telecel', Vodafone: 'vodafone',
} as const;

export const ProductTypes = {
  Physical: 'physical', Digital: 'digital', Service: 'service', Voucher: 'voucher',
  Custom: 'custom', Cause: 'cause',
} as const;
export const ProductShipmentTypes = {
  Delivery: 'delivery', Download: 'download', Render: 'render', Service: 'service', Stream: 'stream',
} as const;
export const ProductShipmentInputTypes = {
  Delivery: 'delivery', Download: 'download', Render: 'render', Stream: 'stream',
} as const;
export const LineItemTypes = { Product: 'product', Fee: 'fee', Shipping: 'shipping' } as const;

export const PurchaseIntentStatuses = {
  Active: 'active', Expired: 'expired', Inactive: 'inactive', Used: 'used',
} as const;
export const PurchaseIntentActivityTypes = {
  ExpiredViewed: 'expired_viewed', OrderCreated: 'order_created',
  PaymentFailed: 'payment_failed', PaymentStarted: 'payment_started', Viewed: 'viewed',
} as const;

export const FinancialAccountTypes = {
  Wallet: 'wallet', BankAccount: 'bank_account', DoshAccount: 'dosh_account',
} as const;
...
export const MessageTemplateVariableTypes = {
  String: 'string', Number: 'number', Integer: 'integer', Boolean: 'boolean', Url: 'url',
  Email: 'email', Phone: 'phone', Date: 'date', Datetime: 'datetime', Array: 'array',
} as const;
...
export const ContentSafetyStatuses = {
  Allowed: 'allowed', Rejected: 'rejected', Quarantined: 'quarantined',
} as const;
...
export const CheckoutOrderStatuses = {
  Preparing: 'preparing', RequiresPayment: 'requires_payment', Completed: 'completed',
  Canceled: 'canceled', Expired: 'expired',
} as const;
export const OrderStatuses = {
  Preparing: 'preparing', RequiresPayment: 'requires_payment', Paid: 'paid',
  Completed: 'completed', Canceled: 'canceled', Expired: 'expired', Unknown: 'unknown',
} as const;
export const OrderPaymentStatuses = {
  Initiated: 'initiated', RequiresAction: 'requires_action', Overdue: 'overdue',
  Executed: 'executed', Paid: 'paid', Canceled: 'canceled', Expired: 'expired',
  Failed: 'failed', Unknown: 'unknown',
} as const;
export const PaymentAttemptStatuses = {
  Initiated: 'initiated', Executed: 'executed', Succeeded: 'succeeded',
  Canceled: 'canceled', Expired: 'expired', Failed: 'failed', Unknown: 'unknown',
} as const;
export const CheckoutPaymentStatuses = {
  RequiresAction: 'requires_action', Processing: 'processing', Succeeded: 'succeeded',
  Failed: 'failed', Cancelled: 'cancelled',
} as const;
export const PaymentResponseStatuses = {
  Pending: 'pending', RequiresConfirmation: 'requires_confirmation', Processing: 'processing',
  Succeeded: 'succeeded', Failed: 'failed',
} as const;
export const OrderCreatedFromResourceTypes = { PurchaseIntent: 'purchase_intent' } as const;

export const RefundReasons = {
  RequestedByCustomer: 'requested_by_customer', Duplicate: 'duplicate', Fraudulent: 'fraudulent',
  OrderCanceled: 'order_canceled', ItemReturned: 'item_returned', ItemDamaged: 'item_damaged',
  ItemNotReceived: 'item_not_received', ItemNotAsDescribed: 'item_not_as_described', Custom: 'custom',
} as const;
export const RefundStatuses = {
  Canceled: 'canceled', Failed: 'failed', Pending: 'pending', Processing: 'processing',
  Succeeded: 'succeeded',
} as const;
export const BalanceTransactionTypes = { Payment: 'payment', Refund: 'refund' } as const;
export const PayoutStatuses = {
  Initialized: 'initialized', Scheduled: 'scheduled', Processing: 'processing',
  Executing: 'executing', Succeeded: 'succeeded', Invalid: 'invalid', Canceled: 'canceled',
} as const;
...
export const ChimeEmailSchemaKinds = {
  GmailViewAction: 'gmail_view_action', SchemaOrgOrder: 'schema_org_order',
  SchemaOrgInvoice: 'schema_org_invoice',
} as const;

export const OtpAlphabetTypes = {
  Numeric: 'numeric', Alpha: 'alpha', Alphanumeric: 'alphanumeric',
} as const;
export const OtpStatuses = {
  Canceled: 'canceled', Expired: 'expired', Pending: 'pending',
  PendingDelivery: 'pending_delivery', PendingVerification: 'pending_verification', Verified: 'verified',
} as const;
export const OtpTransmissionStatuses = {
  Delivered: 'delivered', Failed: 'failed', Submitted: 'submitted',
} as const;
